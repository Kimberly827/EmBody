...
psychoJS.start({
  ...
  resources: [
    ...
    {'name': 'I1.png', 'path': 'I1.png'},
    {'name': 'Con3.png', 'path': 'Con3.png'},    
    {'name': 'STAIT.xlsx', 'path': 'STAIT.xlsx'},
    {'name': 'STICSA.xlsx', 'path': 'STICSA.xlsx'},    
    {'name': 'Con6.png', 'path': 'Con6.png'},
    {'name': 'I5.png', 'path': 'I5.png'},
    {'name': 'Con1.png', 'path': 'Con1.png'},
    {'name': 'I3.png', 'path': 'I3.png'},
    {'name': 'BisBasQ.xlsx', 'path': 'BisBasQ.xlsx'},
    {'name': 'ConSlideXL.xlsx', 'path': 'ConSlideXL.xlsx'},    
    {'name': 'Con2.png', 'path': 'Con2.png'},    
    {'name': 'GHQ.xlsx', 'path': 'GHQ.xlsx'},
    {'name': 'Con5.png', 'path': 'Con5.png'},
    {'name': 'Con4.png', 'path': 'Con4.png'},
    {'name': 'I2.png', 'path': 'I2.png'},
    {'name': 'DemoQuestions.xlsx', 'path': 'DemoQuestions.xlsx'},
    {'name': 'I6.png', 'path': 'I6.png'},
    {'name': 'I7.png', 'path': 'I7.png'},
    {'name': 'PSS.xlsx', 'path': 'PSS.xlsx'},    
    {'name': 'I4.png', 'path': 'I4.png'},      
    {'name': 'base.png', 'path': 'base.png'},    
    {'name': 'envimxl.xlsx', 'path': 'envimxl.xlsx'},
...
function experimentInit() {
  ...
  move_away_flash = new visual.TextStim({
    ...
    text: 'Remember to move away as far as possible from the yellow square',
    font: 'Arial',
    units: undefined, 
  ...
  movpt.push([[14,10,0,7,13,14,9,11,2,1,1,6,13,10,11,4,11,2,15,15,6,7,6,6,1,10,1,13,10,1,5,0,3,1,5,11,9,4,8,8,11,4,7,0,8,6,1,14,12,15,2,3,1,12,15,11,7,14,1,8,8,9,2,0,3,2,0,6,9,15,0,12,13,14,5,2,6,9,0,7,14,10,0,7,13,14,9,11,2,1,1,6,13,10,11,4,11,2,15,15,6,7,6,6,1,10,1,13,10,1,5,0,3,1,5,11,9,4,8,8,11,4,7,0,8,6,1,14,12,15,2,3,1,12,15,11,7,14,1,8,8,9,2,0,3,2,0,6,9,15,0,12,13,14,5,2,6,9,0,7,14,10,0,7,13,14,9,11,2,1,1,6,13,10,11,4,11,2,15,15,6,7,6,6,1,10,1,13,10,1,5,0,3,1,5,11,9,4,8,8,11,4,7,0,8,6,1,14,12,15,2,3,1,12,15,11,7,14,1,8,8,9,2,0,3,2,0,6,9,15,0,12,13,14,5,2,6,9,0,7,14,10,0,7,13,14,9,11,2,1,1,6,13,10,11,4,11,2,15,15,6,7,6,6,1,10,1,13,10,1,5,0,3,1,5,11,9,4,8,8,11,4,7,0,8,6,1,14,12,15,2,3,1,12,15,11,7,14,1,8,8,9,2,0,3,2,0,6,9,15,0,12,13,14,5,2,6,9,0,7],
  [1,9,13,4,1,14,8,11,14,2,2,10,2,4,6,11,10,15,14,2,7,6,8,8,1,5,15,14,7,0,9,0,3,1,11,10,7,5,9,6,5,5,9,15,12,6,13,2,3,1,15,12,15,8,13,8,4,1,2,11,10,9,13,13,7,1,1,11,8,2,0,12,14,14,6,2,10,7,0,3,1,9,13,4,1,14,8,11,14,2,2,10,2,4,6,11,10,15,14,2,7,6,8,8,1,5,15,14,7,0,9,0,3,1,11,10,7,5,9,6,5,5,9,15,12,6,13,2,3,1,15,12,15,8,13,8,4,1,2,11,10,9,13,13,7,1,1,11,8,2,0,12,14,14,6,2,10,7,0,3,1,9,13
LoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisEmbody_postexp_loop of embody_postexp_loop) {
...
function DemoQLoopLoopBegin(DemoQLoopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisDemoQLoop of DemoQLoop) {
...
function STAILoopLoopBegin(STAILoopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisSTAILoop of STAILoop) {
...
function BISBASLoopLoopBegin(BISBASLoopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisBISBASLoop of BISBASLoop) {
...
function STICSA_LoopLoopBegin(STICSA_LoopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisSTICSA_Loop of STICSA_Loop) {
...
function BPQ_LoopLoopBegin(BPQ_LoopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisBPQ_Loop of BPQ_Loop) {
...
function DASS21_LoopLoopBegin(DASS21_LoopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisDASS21_Loop of DASS21_Loop) {
...
function MAIA_LoopLoopBegin(MAIA_LoopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisMAIA_Loop of MAIA_Loop) {
...
function start_exampleRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of start_exampleComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Question_Anx_ExampleRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of Question_Anx_ExampleComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function embody_q_exampleRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of embody_q_exampleComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
    ...
    if (mouse_body_2.status === PsychoJS.Status.STARTED) {  // only update if started and not finished!
      ...
      if (!_mouseButtons.every( (e,i,) => (e == prevButtonState[i]) )) { // button state changed?
        ...
        if (_mouseButtons.reduce( (e, acc) => (e+acc) ) > 0) { // state changed to a new click
          ...
          cx[mousenum].setPos([_mouseXYs[0],_mouseXYs[1]]);
          cx[mousenum].setSize([csize,csize]); // csize = 1/60 now
          if (_mouseXYs[0]<0) {
            cx[mousenum].setFillColor(new util.Color('black'));
            //cx[mousenum].setFillColor(new util.Color([1,-1,-1]));
          } else {
            cx[mousenum].setFillColor(new util.Color([-1,-1,1]));
          }        
          cx[mousenum].setAutoDraw(true);
          mousenum+=1;     
...
function dummy_trial_embodyRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of dummy_trial_embodyComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function dummy_trial_embodyRoutineEnd(snapshot) {
  return function () {
    ...
    if (isdummyStart) {
        ...
        psychoJS.experiment.addData('embody_playerTILx',playerTILx_t);
        psychoJS.experiment.addData('embody_playerTILy',playerTILy_t);
        psychoJS.experiment.addData('embody_predx',predx_t);
        psychoJS.experiment.addData('embody_predy',predy_t);
        psychoJS.experiment.addData('embody_threatpos',threatpos_t);
        psychoJS.experiment.addData('embody_playerTILspd',playerTILspd_t );
        psychoJS.experiment.addData('embody_predspd',predspd_t);
        psychoJS.experiment.addData('embody_caught',caught);
        psychoJS.experiment.addData('embody_caught_flag',caught_flag);
        psychoJS.experiment.addData('embody_threat_get',get_threat);
        psychoJS.experiment.addData('embody_attacktime',attacktime);    
        psychoJS.experiment.addData('embody_trialtime',trialtime);
        psychoJS.experiment.addData('embody_trialframe',trialframe);    
        if (embody_cond>1) {
            if (caught_flag==1) {
...
function embody_qRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of embody_qComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Question_AnxRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of Question_AnxComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function embody_postexp_ExplanationRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of embody_postexp_ExplanationComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function embody_q_postexpRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of embody_q_postexpComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function DemoQ_ExplanationRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of DemoQ_ExplanationComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function DemoQRoutimeRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of DemoQRoutimeComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function STAI_InstructionRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of STAI_InstructionComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function STAI_RoutineRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of STAI_RoutineComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function BISBAS_InstructionRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of BISBAS_InstructionComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function BISBAS_RoutineRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of BISBAS_RoutineComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function STICSA_InstructionRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of STICSA_InstructionComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function STICSA_RoutineRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of STICSA_RoutineComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function BPQ_instructionRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of BPQ_instructionComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function BPQ_RoutineRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of BPQ_RoutineComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function DASS21_InstructionRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of DASS21_InstructionComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function DASS21_RoutineRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of DASS21_RoutineComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function MAIA_InstructionRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of MAIA_InstructionComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function MAIA_RoutineRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of MAIA_RoutineComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function FinalScreenRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of FinalScreenComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
