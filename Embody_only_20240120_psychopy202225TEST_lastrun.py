...
expName = 'Embody_only_20240120_psychopy202225TEST'  # from the Builder filename that created this script
expInfo = {
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='G:\\My Drive\\EmBody\\Embody_only_20240120_psychopy202225TEST_lastrun.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    Intro1Components = [image, key_resp_2]
    ...
    _key_resp_3_allKeys = []
    # keep track of which components have finished
    Intro2Components = [image_2, key_resp_3]
    ...
    while continueRoutine:
        ...
        if key_resp_3.status == STARTED and not waitOnFlip:
            theseKeys = key_resp_3.getKeys(keyList=['y','n','left','right','space','return'], ignoreKeys=["escape"], waitRelease=False)
    ...
    _key_resp_4_allKeys = []
    # keep track of which components have finished
    Intro3Components = [image_3, key_resp_4]
    ...
    while continueRoutine:
        ...
        if key_resp_4.status == STARTED and not waitOnFlip:
            theseKeys = key_resp_4.getKeys(keyList=['y','n','left','right','space','return'], ignoreKeys=["escape"], waitRelease=False)
